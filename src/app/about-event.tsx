...
const EVENT_INFO = [
  {
    ...
    description: "We offer a wide variety of payment options for your convenience.",
  },
  {
    icon: "/image/icon2.png", // Replace with an actual icon or SVG
    title: "Strong Security",
    description: "Your data and funds are secure with us thanks to cutting-edge security.",
  },
  {
    icon: "/image/icon3.png", // Replace with an actual icon or SVG
    title: "Legal Compliance",
    description: "We adhere to strict legal regulations to keep you and your investments safe.",
  },
  {
    icon: "/image/icon4.png", // Replace with an actual icon or SVG
    title: "World Coverage",
    description: "We offer global services to ensure you can access our platform anywhere.",
  },
  {
  ...
  },
  {
    ...
    description: "Our platform is accessible on all devices to ensure seamless usage.",
  },
];
    ...
    <section className="container mx-auto  px-4 py-10 bg-[#e3ebf0]">
      <div className="lg:flex lg:justify-between lg:items-center gap-10">
        ...
        <div className="lg:w-1/2">
          <h2 className="text-left text-red-600 font-semibold mb-2 uppercase">Core Features</h2>
          <h1 className="text-left text-3xl font-bold mb-4">Why We Are Above Others</h1>
          <p className="text-left text-gray-600 mb-6">
            Your stock broker will hold your funds. Thus, it is important you verify it is safe. Stock Birds easily circumvents this concern as we are registered with and duly regulated by the European Securities and Investments Commission. Consequently, you can be sure that we will always keep you and your funds safe.
          </p>
          <p className="text-left text-gray-600 mb-8">
            Our work draws on more than 10 years of experience. They are delivered by over 5,000 professionals in the world&apos;s most important financial centers.
          </p>
      ...
      <section className="container mx-auto px-4 py-10">
        <div className="lg:flex lg:justify-between lg:items-center gap-10">
          {/* Left Section - Text */}
          <div className="lg:w-1/2">
            <h2 className="text-left text-red-600 font-semibold mb-2 uppercase">Profit Graph</h2>
            ...
            <p className="text-left text-gray-600 mb-4">
              <strong>Security:</strong> we offer protection when your customers have financial.
            </p>
            <p className="text-left text-gray-600 mb-8">
              <strong>Flexibility:</strong> funding grows in line with your daily sales update.
            </p>
            <button style={{backgroundColor:'#2a367e'}} className="px-6 py-3 text-white w-64 font-semibold rounded-3xl">
              Contact Us
            </button>
          </div>
          ...
          <div className="lg:w-1/2 mt-8 lg:mt-0">
            ...
            <p className="text-right text-gray-600 mt-4">
              <strong>Annual Report:</strong> From 2012 to 2020 the growth rate grew +29,999.40%
            </p>
          </div>
        </div>
      </section>
