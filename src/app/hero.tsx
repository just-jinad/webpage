  ...
  const texts = [
    {
      ...
      description: "At our core, we provide innovative solutions that are tailored to meet your needs.",
      button: "Learn More"
    },
    {
      heading: "Reliable Technology",
      subheading: "Technology you can trust",
      description: "Harness the power of reliable technology to boost your business operations.",
      button: "Discover Now"
    },
    {
      heading: "Future Ready",
      subheading: "Building the future with AI",
      description: "Prepare for tomorrow's challenges with cutting-edge AI technology solutions.",
      button: "Get Started"
    },
  ];
